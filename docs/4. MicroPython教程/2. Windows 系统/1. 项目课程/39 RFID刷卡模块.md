...
上传代码前先添加库。打开Thonny，在文件管理框单击“**此电脑**”，双击“**（D:）**”，然后双击展开“**代码**”文件夹。展开“**39 RFID RC522**”文件夹，右键单击“**mfrc522_config.py**”，选择“**上传到/**”，等待被上传到ESP32。然后继续用相同的操作将“**mfrc522_i2c.py**”和“**soft_iic.py**”上传到ESP32。

**<span style="background:#ff0;color:#000">注意：在上传代码前先接好模块，否则代码可能上传不成功。</span>**

选中“**D:\代码**”路径，打开代码文件''**lesson_39_mfrc522.py**"。
...
**注意：不同的IC卡和钥匙扣，其数据是不一样的。**<span style="background:#ff0;color:#000">请记录下你的IC卡和钥匙扣的UID码，第53课会用到。</span>
